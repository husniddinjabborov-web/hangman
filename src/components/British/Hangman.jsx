...
import data from '../../data/British.json'
...
function Hangman() {
  ...
  useEffect(() => {
    ...
    const storedData = localStorage.getItem('hangman-british');
    if (!storedData) {
      localStorage.setItem('hangman-british', JSON.stringify(data));
    }
    const parsedData = JSON.parse(localStorage.getItem('hangman-british'));
    setItems(parsedData);
  ...
  const handleNextGroup = () => {
    ...
    if (completedGroup) {
      ...
      localStorage.setItem('learned-british', JSON.stringify(newLearnedGroups));
      localStorage.setItem('hangman-british', JSON.stringify(updatedItems));
    ...
    if (netCompletedGroup) {
      ...
      localStorage.setItem('flashcard-british', JSON.stringify(newFlashcardGroups));
      localStorage.setItem('hangman-british', JSON.stringify(updatedItems));
    ...
    if (!completedGroup && !netCompletedGroup) {
      localStorage.setItem('hangman-british', JSON.stringify(items));
    }
  };
  ...
  const getDisplayIndex = () => {
    const storedData = JSON.parse(localStorage.getItem('hangman-british'));
